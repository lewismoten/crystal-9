...
def test_int3_group4_input_qat_records_only_input_tables_as_trainable(tmp_path: Path):
    report = training.run_mixed_int3_suffix_output_bias_router_weight_group4_router_bias_expert_biases_input_group4_qat(
        epochs=0,
        histories=[""],
        source_path=SOURCE,
        output_dir=tmp_path,
