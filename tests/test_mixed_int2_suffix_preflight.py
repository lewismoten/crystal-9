...
def test_int2_suffix_direct_preflight_records_zero_trainable_scope(tmp_path: Path):
    ...
    report = training.run_mixed_int2_suffix_direct_preflight(
        source_path=source,
    ...
    assert report["layout"] == "mixed-int2-rowwise-suffix-direct-materialization"
