...
def test_int3_group2_position_qat_records_only_position_table_as_trainable(tmp_path: Path):
    report = training.run_mixed_int3_suffix_output_bias_router_weight_group4_router_bias_expert_biases_position_group2_qat(
        epochs=0,
        histories=[""],
        source_path=SOURCE,
        output_dir=tmp_path,
    ...
    assert report["trainable_tensors"] == ["position.weight"]
