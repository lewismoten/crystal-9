...
def test_expert_bias_int4_forward_matches_materialized_runtime():
    ...
    expected = source.forward_mixed_int4_input_attention_groups(
        ...
        quantize_router_bias=True, quantize_expert_biases=True,
    )
    actual = materialize_mixed_int4_input_attention_q_v_out_k_output_bias_router_weight_input_bias_router_bias_expert_biases(source)(tokens)
