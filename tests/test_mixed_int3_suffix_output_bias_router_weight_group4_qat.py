...
def test_int3_router_weight_group4_qat_records_isolated_trainable_scope(tmp_path: Path):
    report = training.run_mixed_int3_suffix_output_bias_router_weight_group4_qat(
        epochs=0,
        histories=[""],
